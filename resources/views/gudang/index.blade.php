    ...
    <x-slot name="slot">
        ...
        <section class="menu-catalog">
            <header class="menu-catalog__heading">
                <h3>{{ $title }}</h3>
                <p>Pilih menu gudang yang ingin dibuka.</p>
            </header>

            <div class="menu-catalog__grid">
                <a href="{{ route('transaksi.penerimaan.index') }}" class="menu-tile">
                    <div class="menu-tile__body">
                        <div class="menu-tile__icon">
                            <i class="fas fa-boxes" style="font-size: 42px; color: #3457b2;"></i>
                        </div>
                        <div class="menu-tile__eyebrow">Menu {{ $title }}</div>
                        <h4 class="menu-tile__title">Penerimaan Stok</h4>
                        <p class="menu-tile__description">Menerima stok pakan dan vitamin dari beberapa nota pembelian.</p>
