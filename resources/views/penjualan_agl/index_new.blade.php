    ...
    <x-slot name="slot">
        <style>
            ...
            @media (max-width: 575.98px) {
                ...
                .menu-tile:hover, .menu-tile:focus { transform: none; }
                ...
                .menu-tile__icon img { width: 43px; height: 43px; }
        ...
        <section class="menu-catalog">
            <header class="menu-catalog__heading">
                <h3>{{ $title }}</h3>
                <p>Pilih menu yang ingin dibuka untuk melihat dan mengelola data penjualan.</p>
            </header>

            <div class="menu-catalog__grid">
                <a href="{{ route('dashboard_kandang.penjualan_umum') }}" class="menu-tile">
                    <div class="menu-tile__body">
                        <div class="menu-tile__icon">
                            <i class="fas fa-shopping-cart" style="font-size: 42px; color: #3457b2;"></i>
                        </div>
                        <div class="menu-tile__eyebrow">Menu {{ $title }}</div>
                        <h4 class="menu-tile__title">Penjualan Umum</h4>
                        <p class="menu-tile__description">Kelola transaksi penjualan umum, tambah penjualan, lihat history, dan kelola data produk.</p>
                ...
                <a href="{{ route('penjualan.telur') }}" class="menu-tile">
                    <div class="menu-tile__body">
                        <div class="menu-tile__icon">
                            <i class="fas fa-egg" style="font-size: 42px; color: #fd7e14;"></i>
                        </div>
                        <div class="menu-tile__eyebrow">Menu {{ $title }}</div>
                        <h4 class="menu-tile__title">Penjualan Telur</h4>
                        <p class="menu-tile__description">Kelola transaksi penjualan telur, buat invoice, kelola customer, dan tracking pengiriman.</p>
                        <div class="menu-tile__action">
                            <span>Buka menu</span>
                            <span class="menu-tile__arrow"><i class="fas fa-arrow-right"></i></span>
                        </div>
