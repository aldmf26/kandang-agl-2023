<table width="100%" cellpadding="10px">
    ...
    <tr>
        <th style="background-color: white;" width="10%">Rak</th>
        <th style="background-color: white;" width="2%">:</th>
        <th style="background-color: white;">{{ $head_invoice->rak_tf ?? 0 }}</th>
...
<table class="table table-hover table-bordered dborder">
    ...
    <tfoot>
        <td align="center" class="fw-bold" colspan="8">Total</td>
