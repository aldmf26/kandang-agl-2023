                            ...
                            GROUP by a.id_telur;");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="pcs[]"
                                            class="pcs_opname_biasa{{ $p->id_produk_telur }}"
                                            value="{{ empty($telur->pcs) ? '0' : $telur->pcs }}">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="kg[]"
                                            class="kg_opname_biasa{{ $p->id_produk_telur }}"
                                            value="{{ empty($telur->kg) ? '0' : $telur->kg }}">
                                    </td>
                                    <td>
                                        <input style="text-align: right" type="text"
                                            class="form-control pcs_selisih{{ $p->id_produk_telur }}" value="0"
                                            readonly>
                                    ...
                                    <td>
                                        <input style="text-align: right" type="text"
                                            class="form-control kg_selisih{{ $p->id_produk_telur }}" value="0"
                                            readonly>
