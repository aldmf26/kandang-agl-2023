    ...
    <table class="table table-bordered table-hover " id="">
        <thead>
            ...
            <tr>
                ...
                <th width="1%" class="dhead text-center">Mati / Jual <i class="fas text-white fa-question-circle rumus"
                    ...
                    $kelasTtlPcsTelur = $ttlPcs - $ttlPcsKemarin < -60 ? 'merah' : 'abu' ; $kelasTtKgTelur=$ttlKg -
                        ...
                        $kelas = $gr_perekor < 100 ? 'merah' : 'putih' ; @endphp <td data-bs-toggle="modal"
                            ...
                            <td align="center" style="white-space: nowrap">
                                ...
                                <a href="#" class="badge bg-warning edit_kandang" id_kandang="{{$d->id_kandang}}"
                                    data-bs-toggle="modal" data-bs-target="#edit_kandang"><i
