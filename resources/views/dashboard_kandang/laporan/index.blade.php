    ...
    <x-slot name="slot">
        ...
        <section class="menu-catalog">
            <header class="menu-catalog__heading">
                <h3>{{ $title }}</h3>
                <p>Pilih laporan yang ingin dibuka.</p>
            </header>

            <div class="menu-catalog__grid">
                <a href="{{ route('dashboard_kandang.laporan_export') }}" class="menu-tile">
                    <div class="menu-tile__body">
                        <div class="menu-tile__icon">
                            <i class="fas fa-file-export" style="font-size: 42px; color: #3457b2;"></i>
                        </div>
                        <div class="menu-tile__eyebrow">Menu {{ $title }}</div>
                        <h4 class="menu-tile__title">Laporan Export</h4>
                        <p class="menu-tile__description">Export Excel Daily Layer, Weekly Layer, dan Perencanaan.</p>
                ...
                <a href="{{ route('dashboard_kandang.laporan_kandang_harian') }}" class="menu-tile">
                    <div class="menu-tile__body">
                        <div class="menu-tile__icon">
                            <i class="fas fa-clipboard-check" style="font-size: 42px; color: #20c997;"></i>
                        </div>
                        <div class="menu-tile__eyebrow">Menu {{ $title }}</div>
                        <h4 class="menu-tile__title">Laporan Kandang Harian</h4>
                        <p class="menu-tile__description">Rekap harian per kandang: populasi, telur, dan pakan.</p>
                        <div class="menu-tile__action">
                            <span>Buka menu</span>
                            <span class="menu-tile__arrow"><i class="fas fa-arrow-right"></i></span>
                        </div>
